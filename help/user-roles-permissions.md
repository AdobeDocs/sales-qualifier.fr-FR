...
| --- | --- | --- |
| `Sales Qualifier` | Chaque utilisateur, y compris les administrateurs | Accès à l’application : prospects, comptes, plans d’engagement, tâches, performances et paramètres de profil. |
